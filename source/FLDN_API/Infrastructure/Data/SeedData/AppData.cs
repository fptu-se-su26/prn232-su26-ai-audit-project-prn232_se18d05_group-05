...
public class AppData
{
    public static async Task SeedAsync(ApplicationDbContext context)
    {
        ...
        {
            new() { Id = Guid.Parse("d1111111-1111-1111-1111-111111111111"), Name = "Quận Hải Châu",      Code = "HC"  },
            new() { Id = Guid.Parse("d2222222-2222-2222-2222-222222222222"), Name = "Quận Thanh Khê",     Code = "TK"  },
            new() { Id = Guid.Parse("d3333333-3333-3333-3333-333333333333"), Name = "Quận Sơn Trà",       Code = "ST"  },
            new() { Id = Guid.Parse("d4444444-4444-4444-4444-444444444444"), Name = "Quận Ngũ Hành Sơn",  Code = "NHS" },
            new() { Id = Guid.Parse("d5555555-5555-5555-5555-555555555555"), Name = "Quận Liên Chiểu",    Code = "LC"  },
            new() { Id = Guid.Parse("d6666666-6666-6666-6666-666666666666"), Name = "Quận Cẩm Lệ",        Code = "CL"  },
            new() { Id = Guid.Parse("d7777777-7777-7777-7777-777777777777"), Name = "Huyện Hòa Vang",     Code = "HV"  },
            new() { Id = Guid.Parse("d8888888-8888-8888-8888-888888888888"), Name = "Huyện Hoàng Sa",     Code = "HS"  },
        };
        var existingIds = await context.Districts.Select(d => d.Id).ToListAsync();
        var toAdd = allDistricts.Where(d => !existingIds.Contains(d.Id)).ToList();
        if (toAdd.Count > 0)
        {
            await context.Districts.AddRangeAsync(toAdd);
            await context.SaveChangesAsync();
        }
        ...
        if (!await context.Addresses.AnyAsync())
        {
            ...
            var addresses = new List<Address>
            {
                new()
                {
                    ...
                    UserId = userId,
                    ReceiverName = "Điểm Phân Phối Hải Châu",
                    ReceiverPhone = "0901234567",
                    FullAddress = "123 Trần Phú, Phường Hải Châu 1, Quận Hải Châu, Đà Nẵng",
                    DistrictId = districtId,
                    IsDefault = true,
                    IsActive = true,
                    IsDeleted = false
                ...
                new()
                {
                    ...
                    UserId = userId,
                    ReceiverName = "Kho Phân Phối Liên Chiểu",
                    ReceiverPhone = "0909876543",
                    FullAddress = "45 Nguyễn Lương Bằng, Phường Hòa Khánh Bắc, Quận Liên Chiểu, Đà Nẵng",
                    DistrictId = districtId,
                    IsDefault = false,
                    IsActive = true,
                    IsDeleted = false
