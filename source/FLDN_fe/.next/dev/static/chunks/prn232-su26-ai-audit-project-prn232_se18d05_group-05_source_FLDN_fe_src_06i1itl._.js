...
function DashboardPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(145);
    if ($[0] !== "c4a0d89c19b69820634d45a4771f5c1af25e70ead314d40df8ac6271f52f22dd") {
        for(let $i = 0; $i < 145; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c4a0d89c19b69820634d45a4771f5c1af25e70ead314d40df8ac6271f52f22dd";
    }
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$src$2f$stores$2f$auth$2e$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])(_DashboardPageUseAuthStore);
    let t0;
    let t1;
    if ($[1] !== router || $[2] !== user) {
        t0 = ({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(t0, t1);
    ...
    const base = t7;
    let t8;
    if ($[12] !== base || $[13] !== inventoryOverrides) {
        let t9;
        if ($[15] !== inventoryOverrides) {
            t9 = ({
        ...
        t8 = base.map(t9);
        $[12] = base;
        $[13] = inventoryOverrides;
        $[14] = t8;
    } else {
        t8 = $[14];
    }
    const productsList = t8;
    let t9;
    if ($[17] !== supplyRequestsData) {
        t9 = supplyRequestsData ?? [];
        $[17] = supplyRequestsData;
        $[18] = t9;
    } else {
        t9 = $[18];
    }
    const base_0 = t9;
    let t10;
    if ($[19] !== base_0 || $[20] !== statusOverrides) {
        let t11;
        if ($[22] !== statusOverrides) {
            t11 = ({
    ...
    const base_1 = t11;
    let t12;
    if ($[26] !== base_1 || $[27] !== deletedBatchCodes) {
        let t13;
        if ($[29] !== deletedBatchCodes) {
            t13 = ({
            ...
            $[29] = deletedBatchCodes;
            $[30] = t13;
        } else {
            t13 = $[30];
        }
        t12 = base_1.filter(t13);
        $[26] = base_1;
        $[27] = deletedBatchCodes;
        $[28] = t12;
    } else {
        t12 = $[28];
    }
    const batchesList = t12;
    let t13;
    if ($[31] !== productsList) {
        t13 = productsList.filter(_DashboardPageProductsListFilter).length || productsList.length;
        $[31] = productsList;
        $[32] = t13;
    } else {
        t13 = $[32];
    }
    const activeProductsCount = t13;
    let t14;
    if ($[33] !== productsList) {
        t14 = productsList.reduce(_DashboardPageProductsListReduce, 0);
        $[33] = productsList;
        $[34] = t14;
    } else {
        t14 = $[34];
    }
    const totalStockKg = t14;
    let t15;
    if ($[35] !== supplyRequestsList) {
        t15 = supplyRequestsList.filter(_DashboardPageSupplyRequestsListFilter);
        $[35] = supplyRequestsList;
        $[36] = t15;
    } else {
        t15 = $[36];
    }
    const pendingRequestsList = t15;
    const pendingRequestsCount = pendingRequestsList.length;
    let t16;
    if ($[37] === Symbol.for("react.memo_cache_sentinel")) {
        t16 = new Date("2026-07-25").getTime();
        $[37] = t16;
    } else {
        t16 = $[37];
    }
    ...
    if ($[38] !== batchesList) {
        ...
        t17 = batchesList.filter(t18);
        $[38] = batchesList;
        $[39] = t17;
    } else {
        t17 = $[39];
    }
    const expiringBatchesList = t17;
    let t18;
    if ($[41] !== searchTerm || $[42] !== statusFilter || $[43] !== supplyRequestsList) {
        let t19;
        if ($[45] !== searchTerm || $[46] !== statusFilter) {
            t19 = ({
        ...
        t18 = supplyRequestsList.filter(t19);
        $[41] = searchTerm;
        $[42] = statusFilter;
        $[43] = supplyRequestsList;
        $[44] = t18;
    } else {
        t18 = $[44];
    }
    const filteredRequests = t18;
    let t19;
    if ($[48] !== refetchInventory || $[49] !== refetchProducts || $[50] !== refetchRequests) {
        t19 = ({
    ...
    const t23 = `size-4 ${anyFetching ? "animate-spin text-emerald-300" : "text-emerald-200"}`;
    let t24;
    if ($[55] !== t23) {
    ...
    const t25 = anyFetching ? "\u0110ang l\xE0m m\u1EDBi..." : "L\xE0m m\u1EDBi d\u1EEF li\u1EC7u";
    let t26;
    if ($[57] !== anyFetching || $[58] !== handleRefreshAll || $[59] !== t24 || $[60] !== t25) {
    ...
    if ($[66] === Symbol.for("react.memo_cache_sentinel")) {
        t30 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    let t32;
    if ($[68] !== activeProductsCount || $[69] !== isLoadingProducts) {
        t32 = isLoadingProducts ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
        ...
        $[68] = activeProductsCount;
        $[69] = isLoadingProducts;
        $[70] = t32;
    } else {
        t32 = $[70];
    }
    ...
    if ($[78] === Symbol.for("react.memo_cache_sentinel")) {
        t38 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: "text-xs font-bold uppercase tracking-wider text-slate-400",
    ...
    let t40;
    if ($[80] !== isLoadingInventory || $[81] !== isLoadingProducts || $[82] !== totalStockKg) {
        t40 = isLoadingInventory || isLoadingProducts ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
        ...
        $[80] = isLoadingInventory;
        $[81] = isLoadingProducts;
        $[82] = totalStockKg;
        $[83] = t40;
    } else {
        t40 = $[83];
    ...
    if ($[84] === Symbol.for("react.memo_cache_sentinel")) {
        t41 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: "text-xs font-bold text-slate-400",
            children: "kg"
        }, void 0, false, {
            fileName: "[project]/prn232-su26-ai-audit-project-prn232_se18d05_group-05/source/FLDN_fe/src/app/(private)/dashboard/page.tsx",
    ...
    if ($[91] === Symbol.for("react.memo_cache_sentinel")) {
        t46 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    if ($[93] !== isLoadingRequests || $[94] !== pendingRequestsCount) {
        ...
        $[93] = isLoadingRequests;
        $[94] = pendingRequestsCount;
        $[95] = t48;
    } else {
        t48 = $[95];
    }
    ...
    if ($[99] === Symbol.for("react.memo_cache_sentinel")) {
        t51 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    if ($[113] === Symbol.for("react.memo_cache_sentinel")) {
        t60 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$prn232$2d$su26$2d$ai$2d$audit$2d$project$2d$prn232_se18d05_group$2d$05$2f$source$2f$FLDN_fe$2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
            children: [
    ...
    let t63;
    if ($[119] !== filteredRequests || $[120] !== isLoadingRequests) {
        ...
        $[119] = filteredRequests;
        $[120] = isLoadingRequests;
        $[121] = t63;
    } else {
        t63 = $[121];
    }
...
_s(DashboardPage, "DTXs2GQGh3k/QkjA+JpDO/11wNQ=", false, function() {
    return [
...
//# sourceMappingURL=prn232-su26-ai-audit-project-prn232_se18d05_group-05_source_FLDN_fe_src_06i1itl._.js.map