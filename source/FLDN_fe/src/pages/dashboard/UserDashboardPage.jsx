    ...
    <main className="min-h-screen bg-slate-950 px-6 py-16 text-white">
      <div className="mx-auto max-w-5xl space-y-8">
        <div className="rounded-3xl border border-cyan-400/20 bg-cyan-400/10 p-8">
          <p className="text-sm uppercase tracking-[0.3em] text-cyan-200">User Area</p>
          <h1 className="mt-3 text-4xl font-semibold">Bang dieu khien nguoi dung Food Link</h1>
          <p className="mt-3 max-w-3xl text-slate-300">
            Route nay dang duoc bao ve boi `ProtectedRoute` va cho phep `User` hoac `Admin`.
          </p>
        </div>
